...
class UserPostPage extends StatefulWidget {
  final Map arguments;
  UserPostPage({Key key, this.arguments}) : super(key: key);
...
class _UserPostPageState extends State<UserPostPage> {
  ...
  void initState() {
    ...
    dataFuture = homeService.myListPosts(params, (response) {
      var data = response;
  ...
  void getDatas(type) async {
    ...
    var data = await HttpUtil().get(Api.myListPosts, parameters: params);
