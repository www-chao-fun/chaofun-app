                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return InkWell(
                          ...
                          child: new MyConversationView(
                            imageUrl: strNoEmpty(data['avatar']) ? KSet.imgOrigin + data['avatar'] + '?x-oss-process=image/resize,h_80' : 'https://i.chao.fun/biz/08a2d3a676f4f520cb99910496e48b4e.png?x-oss-process=image/resize,h_80',
                            title: data['name'] ?? '',
