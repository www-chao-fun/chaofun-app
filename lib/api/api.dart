...
//  static const String BASE_URL='http://192.168.190.35:8082/wx';
  static const String BASE_URL = 'https://choa.fun';
  ...
  static const String submitVideo = BASE_URL + '/api/v0/submitVideoV1'; //发布视频帖子
  static const String submitAudio = BASE_URL + '/api/submit_audio'; //发布音频帖子
  static const String applyVideoUpload = BASE_URL + '/api/v0/applyVideoOssUploadUrl'; //发布音频帖子
  ...
  static const String saveFolderList =
      BASE_URL + '/api/v0/savefolder/list'; // 列表
