    ...
    return new InkWell(
      child: AnimateWidget(
        ...
        child: new Container(
          ...
          child: new ImageView(
            img:  widget.model['sender']['icon'] == null ?  'https://i.chao.fun/biz/08a2d3a676f4f520cb99910496e48b4e.png?x-oss-process=image/format,webp/quality,q_75/resize,h_80' :  KSet.imgOrigin +
